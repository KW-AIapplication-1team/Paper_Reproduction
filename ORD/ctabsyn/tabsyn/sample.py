...
def main(args):
    ...
    print("DEBUG condition_by:", cond_val, "n_classes:", n_classes)
    ...
    print("DEBUG syn_target unique:", np.unique(syn_target, return_counts=True))
    print("DEBUG syn_target dtype/shape:", syn_target.dtype, syn_target.shape)
